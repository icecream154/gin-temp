...
var (
	...
	DateFormatWithZone         = "2006-01-02T15:04:05+08:00" //  配置文件键值缓存时，键的前缀
	DateFormatWithNonClearZone = "2006-01-02T15:04:05Z"      //  配置文件键值缓存时，键的前缀

	// 全局日志指针
	ZapLog *zap.Logger
	ZapSugarLog *zap.SugaredLogger
	// 全局配置文件
	ConfigYml       ymlconfig_interf.YmlConfigInterf // 全局配置文件指针
	ConfigGormv2Yml ymlconfig_interf.YmlConfigInterf // 全局配置文件指针
	ConfigRpcYml    ymlconfig_interf.YmlConfigInterf // 全局配置文件指针
